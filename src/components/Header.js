...
const Header = () => {
  return (
    <div className='header flex items-center justify-evenly shadow-md h-28'>
      <div className="header_logo flex">
        <Link to="/">
        <img className="rounded-lg w-12 mx-4 my-0" src={LOGO} alt=""/></Link>
        <div><input type="text" placeholder='Others' className='border-b border-gray-400 focus:outline-none focus:border-blue-500'/></div>
      </div>
      
      <div className="nav_list my-10">
        <ul className="flex space-x-10 justify-center">
          ...
          <li className="text-lg flex items-center gap-2">
            <Link to="/search"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
...
Search
          ...
          <li className="text-lg flex items-center gap-2">
            <Link to="/offers"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
...
<Link to="/help">
Help</Link></li>
          <li className="text-lg flex items-center space-x-8">
